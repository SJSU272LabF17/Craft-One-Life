...
router.post('/rejectuser', function (req, res) {
    ...
    console.log("rejectuser",req.body.email);
    var approveUsers = "update users set is_Approved=2  where email='"+req.body.email+"'";
        ...
        mysql.insertData(function (err, results) {
            if (err) {
                ...
                var mailOptions = {
                    from: 'genesisworld23@gmail.com', // sender address
                    to: req.body.email, // list of receivers
                    subject: 'Artist Account Denied ', // Subject line
                    text: 'We have reviewed your profile!\n' +
                    '\n' +
...
router.post('/approvebook', function (req, res) {
    ...
    var photo;
    if(no===1){
        photo='./public/uploads/Cracking the Interview.jpg';
    }
    else if(no===2){
        photo='./public/uploads/The Fury.jpg';
    }
    else if(no===3){
...
router.post('/rejectbook', function (req, res) {


    console.log("reject book",req.body);
    var no=Math.floor(Math.random() * 3) + 1;
    var photo;
    if(no===1){
        photo='./public/uploads/Cracking the Interview.jpg';
